...
import { submitGuidanceForm, type GuidanceFormState } from '@/app/actions';
...
export function GuidanceForm() {
  const [state, formAction] = useActionState(submitGuidanceForm, initialState);
  ...
  return (
    <Card className="w-full max-w-lg shadow-xl">
      <CardHeader>
        <CardTitle className="text-2xl font-headline text-primary">Request Project Guidance</CardTitle>
      ...
      <form action={formAction} ref={formRef}>
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Textarea id="message" name="message" placeholder="Describe your project needs..." rows={5} required className="bg-background/70"/>
